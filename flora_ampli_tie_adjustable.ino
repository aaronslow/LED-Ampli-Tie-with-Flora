I have added a brightness function to the adjustable sketch.  It should work equally well for the dynamic sketch.  I have also added a digital/analog pinout name description to help identify the analog and digital pin names.
...
#define INPUT_CEILING 80 //Max range of analogRead input, the lower the value the more sensitive (1023 = max)
#define BRIGHTNESS 30 //Brightness Level from 1 to 255
